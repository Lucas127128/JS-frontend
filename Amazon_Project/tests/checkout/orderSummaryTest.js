...
import {deliveryOption, getDeliveryDate, addWeekDays} from '../../data/deliveryOption.js'
...
describe("test suite: render order summary", ()=>{
    ...
    it("removes the product", ()=>{
        ...
        const productId1=CheckoutCart[0].ProductId
        const productId2=CheckoutCart[1].ProductId
        let cartItemContainer1 = document.querySelector(`.cart-item-container-${productId1}`)
        let cartItemContainer2 = document.querySelector(`.cart-item-container-${productId2}`)
        const deleteQuantityHTML1 = document.querySelector(`.delete-quantity-link-${productId1}`)
        const deleteQuantityHTML2 = document.querySelector(`.delete-quantity-link-${productId2}`)
        deleteQuantityHTML1.click()
        cartItemContainer = document.querySelectorAll('.cart-item-container')
        cartItemContainer1 = document.querySelector(`.cart-item-container-${productId1}`)
        cartItemContainer2 = document.querySelector(`.cart-item-container-${productId2}`)
